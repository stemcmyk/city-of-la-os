...
Config.Methods = {
	...
	{ name = 'POST', 	allowed = true,  RequestBody = true },
	{ name = 'PUT', 	allowed = true,  RequestBody = true },
	{ name = 'DELETE', 	allowed = true,  RequestBody = false },
	{ name = 'OPTIONS', allowed = false, RequestBody = false },
	{ name = 'PATCH', 	allowed = true,  RequestBody = true }
}
