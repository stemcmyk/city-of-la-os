...
Config.LicenseReplacementFee = 500
Config.LicenseChangeFee = 15000
Config.VanityPlateFee = 5000

Config.BoatPurchaseLicenseFee = 5000

Config.RestoreLicenseFee = 5000



Config.DateFormat = "DD/MM/YYYY"
Config.LowestYear         = 2024 - 120 -- max age 120 years 😂
Config.HighestYear        = 2024 - 18 -- quite obviously min age 18
...
Config.Zones = {
	DMVSchool = {
		...
		Pos = {x = 215.32, y = -1399.01, z = 29.38},
...
Config.CheckPoints = {
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			DrawMissionText(_U("next_point_speed") .. Config.SpeedLimits["residence"] .. " M.P.H.", 5000)
		end
	},
	{
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			Citizen.CreateThread(
				function()
					DrawMissionText(_U("stop_look_left") .. Config.SpeedLimits["town"] .. " M.P.H.", 5000)
					PlaySound(-1, "RACE_PLACED", "HUD_AWARDS", 0, 0, 1)
					FreezeEntityPosition(vehicle, true)
					Citizen.Wait(6000)
					FreezeEntityPosition(vehicle, false)
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			DrawMissionText(_U("hway_time") .. Config.SpeedLimits["freeway"] .. " M.P.H.", 5000)
			PlaySound(-1, "RACE_PLACED", "HUD_AWARDS", 0, 0, 1)
		end
	},
	{
	...
	},
	{
		...
		Action = function(playerPed, vehicle, setCurrentZoneType)
			...
			DrawMissionText(_U("in_town_speed") .. Config.SpeedLimits["town"] .. " M.P.H.", 5000)
		end
	},
	{
