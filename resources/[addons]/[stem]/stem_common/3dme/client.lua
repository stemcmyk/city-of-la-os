...
local c = Config_3dme -- Pre-load the config
local lang = c.Languages[c.language] -- Pre-load the language
local peds = {}
...
local function onShareDisplay(text, target)
    ...
    if (exports.wasabi_ambulance:isPlayerDead(target)) then return end
