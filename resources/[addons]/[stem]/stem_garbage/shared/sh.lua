...
Shared.Locale = {
    ...
    VehicleNear = "Something is in the way of the garage",
    Info = "Pick up your truck nearby then head to the **Starting point**s noted on the map",
    ...
    InvalidVehicle = "This vehicle is not the one you started the job with",
}
