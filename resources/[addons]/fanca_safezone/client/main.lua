CreateThread(function()
    for zoneName,zoneData in pairs(Config.Zones) do
        ...
        if zoneData.blip then
            ...
            if (zoneData.blip.radius and zoneData.sphere) then
                local radiusBlip = AddBlipForRadius(coords.x, coords.y, coords.z, zoneData.sphere.radius)
                SetBlipColour(radiusBlip, zoneData.blip.radiusColor)
                SetBlipAlpha(radiusBlip, zoneData.blip.radiusAlpha) 
                SetBlipDisplay(radiusBlip, zoneData.blip.display)
            end 
