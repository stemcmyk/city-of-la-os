...
function OnEnter(self)
    ...
    if self.zonetype.player then
        if (self.zonetype.disableJobs and exports.stem_common:tableContains(self.zonetype.disableJobs, ESX.PlayerData.job.name)) then
            return notify("Safezone active for CIVs", "success")
        end
