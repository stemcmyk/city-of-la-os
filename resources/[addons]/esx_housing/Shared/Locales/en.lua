Locales['en'] = {
    ...
    ['view_house_info'] = 'Press ~INPUT_CONTEXT~ to see the information about the house',
    ['exit_house'] = 'Press ~INPUT_CONTEXT~ to get out of the house',
    ['open_storage'] = 'Press ~INPUT_CONTEXT~ to open the storage',
    ...
    ['interior_position'] = 'indoor position: ',
