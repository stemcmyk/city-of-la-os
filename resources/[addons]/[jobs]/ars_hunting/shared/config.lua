...
Config.HuntingZones = {
    ["CHILIAD_MOUNTAINS"] = {
        coords = vector3(-700.21, 5089.06, 137.72),
        radius = 430.00,
        maxSpawns = 1,                                                  -- max animals spawned at one time
        allowedWeapons = { "WEAPON_SAUER101", "WEAPON_KNIFE" }, -- nil if you want to allow every weapon
        zone_radius = {
            enable = true,
            color = 1,
            opacity = 128,
        ...
        animals = {
            ...
            },
            {
                ...
                items = {
                    skins = {
                        {
                            item = "leather_boar_bad",
                            chance = 50,
                            maxQuantity = 1,
                        },
                        {
                            item = "leather_boar_good",
                            chance = 30,
                            maxQuantity = 1,
                        },
                        {
                            item = "leather_boar_perfect",
                            chance = 25,
                            maxQuantity = 1,
                        },
                    },
    ...
    -- ["CHILIAD_MOUNTAINS_DANGEROUS"] = {
    --     coords = vector3(-935.49, 5157.86, 157.65),
    --     radius = 150.00,
    --     maxSpawns = 1,                                                  -- max animals spawned at one time
    --     allowedWeapons = { "WEAPON_SAUER101", "WEAPON_KNIFE" }, -- nil if you want to allow every weapon
    --     zone_radius = {
