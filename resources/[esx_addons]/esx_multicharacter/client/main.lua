...
if ESX.GetConfig().Multichar then
    ...
    function FinishBigSkyLoader()
        ...
        while true do
            ...
            if GetGameTimer() - timer > 5000 then
                ...
                LocalPlayer.state.switchComplete = true
    ...
    exports("FinishBigSkyLoader", FinishBigSkyLoader)
    ...
    AddEventHandler("esx_multicharacter:SetupUI", function(data, slots)
        ...
        if not Character then
            ...
            TriggerServerEvent("esx_multicharacter:CharacterChosen", 1, false)
        end
    end)
