return {
	Weapons = {
		...
		['WEAPON_GRENADELAUNCHER'] = {
			label = 'Flashbang Launcher',
			weight = 5500,
			durability = 0.05,
			ammoname = 'ammo-flashbang'
		},
	...
	Components = {
		...
		['mm_g17_slide8'] = {
			label = 'Trijicon RMR Type 2',
			weight = 120,
			type = 'sight',
			client = {
				component = {
					`COMPONENT_G17_SLIDE_08`
				},
				usetime = 2500
			}
		},
