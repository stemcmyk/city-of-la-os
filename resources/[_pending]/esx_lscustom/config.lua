...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {13.95 / 5, 32.56 / 5, 65.12 / 5, 139.53 / 5}
	},
	modBrakes = {
		label = TranslateCap('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {4.65 / 5, 9.3 / 5, 13.95 / 5, 18.6 / 5}
	},
	modTransmission = {
		label = TranslateCap('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {13.95 / 5, 20.93 / 5, 46.51 / 5, 63.55 / 5}
	},
	modSuspension = {
		label = TranslateCap('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {3.72 / 5, 7.44 / 5, 14.88 / 5, 29.77 / 5, 40.2 / 5}
	},
	modArmor = {
		label = TranslateCap('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {69.77 / 10 , 116.28 / 10, 130.00 / 10, 150.00 / 10, 180.00 / 10, 190.00 / 10}
	},
	modTurbo = {
